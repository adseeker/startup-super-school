...
| Sales cycle | 1 week–18 months | Minutes–days |
| TAM reach | Finite (number of businesses) | Potentially hundreds of millions |
| CAC | High ($500–$50K per customer) | Low–medium ($5–$200 per user) |
| Churn | Low (5–15% annually) | High (3–10% monthly) |
| Capital required to scale | Moderate (sales team) | High (paid acquisition, brand) |
| PMF signal | Renewal, expansion, referral | Retention, DAU, organic growth |
| Primary channels | Outbound, partnerships, content | Paid social, SEO, viral loops |
| Path to profitability | Achievable with ~100 customers | Requires scale |
