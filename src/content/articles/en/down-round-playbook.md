---
title: "The Down Round Playbook"
description: "A down round isn't the end. Here's how to navigate a valuation cut - managing dilution, investor relations, and team morale without losing the company."
locale: "en"
category: "fundraising"
tags: ["down round", "fundraising", "valuation", "dilution", "investor relations", "startup survival"]
difficulty: "advanced"
publishedDate: 2026-03-06
readingTime: 11
author: "Startup Super School"
primaryKeyword: "down round startup"
seoKeywords: ["what is a down round", "how to survive a down round", "down round dilution", "down round investor relations"]
faqs:
  - question: "What is a down round?"
    answer: "A down round is a funding round in which a company raises capital at a valuation lower than its previous round. For example, if a company raised its Series B at a $200M valuation and its Series C is priced at $120M, the Series C is a down round. Down rounds trigger dilution for existing shareholders and can activate anti-dilution provisions held by earlier investors."
  - question: "How does a down round affect employee equity?"
    answer: "A down round dilutes all existing shareholders, including employees with stock options or restricted stock. If the strike price on an employee's options is higher than the new share price, those options are 'underwater' - meaning they're worth nothing until the company recovers above that price. Some companies do option repricing after a down round to reset strike prices to the new FMV, which helps retain key employees."
  - question: "Do down rounds trigger anti-dilution provisions?"
    answer: "Yes. Most preferred stock from Series A onward includes anti-dilution provisions. Full ratchet anti-dilution is the most punishing - it resets the investor's conversion price to the new lower price, dramatically increasing their ownership at the expense of founders and employees. Weighted-average anti-dilution is more common and less severe, adjusting the conversion price based on the ratio of new shares to old shares and the price differential."
  - question: "How common are down rounds?"
    answer: "Down rounds are more common than founders expect. During the 2022–2024 venture correction, down rounds represented 20–30% of all funding rounds in some quarters, up from 5–10% during the 2020–2021 peak. High-profile examples include Klarna (from $46B to $6.7B), Stripe (from $95B to $50B), and Instacart. Down rounds are cyclical - they cluster in downturns and are nearly absent during bull markets."
---
...
## The Legal and Dilution Mechanics
...
|------|-------------|--------|
| **Full ratchet** | Resets investor's conversion price to the new lower price | Extremely punishing for founders - rarely used post-2010 |
| **Weighted average (broad-based)** | Adjusts conversion price proportionally based on all shares outstanding | Standard; painful but manageable |
| **Weighted average (narrow-based)** | Same but uses only preferred shares in the denominator | More punishing than broad-based |
