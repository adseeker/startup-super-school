...
primaryKeyword: "equity for early employees startup"
seoKeywords: ["startup equity early employees", "stock options first hires", "employee equity compensation startup", "how much equity early hire"]
faqs:
  - question: "How much equity should you give early employees?"
    answer: "Equity for early employees varies significantly by role, seniority, and stage. At seed stage, a typical range is: first 5 employees (non-founding) 0.1–0.5%, senior hires (VP-level) 0.25–1.0%, directors 0.1–0.4%, and mid-level engineers 0.05–0.2%. These numbers compress significantly at Series A and later. Use sites like Levels.fyi or Carta's benchmarks for current market data, and tie grants to a defined level framework rather than negotiating case by case."
  - question: "What vesting schedule is standard for employee equity?"
    answer: "The industry standard is 4-year vesting with a 1-year cliff. This means: no equity vests in the first 12 months (the cliff), then 25% vests at the one-year mark, and the remaining 75% vests monthly over the following 36 months. Some companies use 4-year schedules without a cliff for senior hires they've thoroughly vetted, and some startups are moving to 4-year, 6-year, or rolling grants to improve long-term retention."
