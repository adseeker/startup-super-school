---
title: "What Is a Startup? A Complete Definition"
description: "Startups are designed to search for a repeatable, scalable business model under extreme uncertainty — they are not just small versions of large companies."
locale: "en"
...
1. **No market need** (cited in 42% of post-mortems) — the problem wasn't worth solving
2. **Ran out of cash** — poor financial management or inability to raise
3. **Wrong team** — missing skills, co-founder conflict, or poor execution
4. **Outcompeted** — a better-funded competitor won the market
5. **Poor product** — never solved the problem well enough to retain users
6. **Pricing / business model** — couldn't find a sustainable way to monetize
