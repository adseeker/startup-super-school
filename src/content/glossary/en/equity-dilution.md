...
description: "Equity dilution occurs when a startup issues new shares, reducing existing shareholders' ownership percentage. It happens at every funding round."
locale: "en"
category: "equity"
...
|--------------------|--------------|----------------|
| Broad-Based Weighted Average | Adjustment based on all shares outstanding | Moderate, proportional dilution |
| Narrow-Based Weighted Average | Adjustment based on preferred shares only | More dilution than BBWA |
| Full Ratchet | Conversion price = new round price | Severe dilution, even for small down rounds |
...
| Stage | Founder Ownership | Company Valuation | Founder's Stake Value |
|-------|-------------------|-------------------|----------------------|
| Founding | 50% | $1,000,000 | $500,000 |
...
| IPO / Exit | Varies | 15–25% is common |
