---
title: "Bridge Round"
description: "A bridge round is a small financing to extend a startup's runway until a larger funding round or key milestone is reached."
locale: "en"
...
1. **No specific milestone defined**: The bridge is not tied to a concrete, measurable goal
2. **Existing investors are reluctant**: If lead investors are hesitant to bridge, their conviction has faded
3. **The core business model is unproven**: More time alone will not answer the fundamental question
4. **This is the second or third bridge**: Serial bridge rounds signal that the company's valuation is stuck and growth is not responding to capital
