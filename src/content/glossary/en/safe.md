...
|---------|--------------------------|--------------------------|
| Cap measured against | Pre-money valuation at next round | Post-money valuation at SAFE round |
| Ownership certainty | Unclear until priced round | Investor knows % at time of signing |
...
|---------|------|------------------|
| Legal structure | Not a debt instrument | Debt (loan) |
| Interest rate | None | Typically 5–8% per year |
| Maturity date | None | Typically 18–24 months |
| Conversion trigger | Priced equity round | Priced round or maturity date |
| Complexity | Simpler, shorter document | More complex, more negotiation |
| Investor protection | Lower (no repayment right unless cap hit) | Higher (debt repayment right) |
| Cost to issue | Lower (no legal fees for debt docs) | Slightly higher |
| Common in | Pre-seed, seed | Seed, bridge rounds |
