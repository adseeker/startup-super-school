...
description: "ACV is the average annualized revenue per customer contract, excluding one-time fees. A core B2B SaaS metric for measuring deal size and forecasting revenue."
locale: "en"
category: "finance"
tags: ["acv", "saas metrics", "revenue", "b2b sales", "contracts"]
difficulty: "beginner"
publishedDate: 2026-03-06
relatedTerms: ["arr", "mrr", "ltv", "cac", "unit-economics", "churn-rate"]
primaryKeyword: "annual contract value ACV"
seoKeywords: ["what is ACV in SaaS", "annual contract value definition", "ACV vs ARR", "how to calculate ACV"]
faqs:
...
|--------|-----------------|-------|
| **ACV** | Average deal size (per customer) | Sales/deal-level |
| **ARR** | Total recurring revenue | Company-level |
...
| Segment | Typical ACV range | Sales motion required |
|---------|------------------|-----------------------|
| SMB (1–50 employees) | $500–$5,000 | Self-serve, PLG |
