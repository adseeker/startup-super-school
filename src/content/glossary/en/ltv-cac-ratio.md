---
title: "LTV:CAC Ratio"
description: "The LTV:CAC ratio measures how much lifetime value you earn per dollar spent acquiring a customer. A 3:1 ratio is the SaaS benchmark."
locale: "en"
category: "growth"
...
seoKeywords: ["ltv cac ratio", "customer lifetime value cac", "what is ltv cac"]
relatedTerms: ["conversion-rate-optimization"]
faqs:
  - question: "What is the LTV:CAC ratio?"
    answer: "The LTV:CAC ratio compares how much revenue a customer generates over their lifetime (LTV, or customer lifetime value) to how much it costs to acquire them (CAC, or customer acquisition cost). A ratio of 3:1 means you earn $3 in lifetime value for every $1 spent on acquisition—the standard benchmark for a healthy SaaS business. A ratio below 1:1 means you are destroying value with every new customer you acquire."
  - question: "How do you calculate LTV?"
    answer: "The standard LTV formula is: LTV = ARPU × Gross Margin ÷ Churn Rate. For example, if average revenue per user is $100/month, gross margin is 70%, and monthly churn is 2%, then LTV = $100 × 0.70 ÷ 0.02 = $3,500. For B2B SaaS with annual contracts, use annual churn instead: LTV = ARR per customer × Gross Margin ÷ Annual Churn Rate."
  - question: "How do you calculate CAC?"
    answer: "CAC = Total sales and marketing spend for a period ÷ Number of new customers acquired in that same period. If you spent $50,000 on sales and marketing in Q1 and acquired 100 new customers, your CAC is $500. Include salaries, ad spend, agency fees, and tooling costs. Blended CAC mixes all channels; paid CAC isolates only paid acquisition spend—both are useful but track them separately."
  - question: "What is the difference between LTV:CAC and payback period?"
    answer: "LTV:CAC measures the total return on your acquisition investment over a customer's lifetime. Payback period measures how many months of gross profit it takes to recover the CAC. Both matter: a 3:1 LTV:CAC with a 36-month payback period means you have a cash flow problem even if the economics are theoretically sound. Best-in-class SaaS targets a payback period under 12 months and an LTV:CAC of 3:1 or higher."
---
...
For B2B SaaS with annual contracts, substitute monthly figures with annual ones:
LTV = Annual contract value per customer × Gross margin ÷ Annual churn rate
