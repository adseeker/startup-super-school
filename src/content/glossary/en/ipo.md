...
seoKeywords: ["IPO startup", "initial public offering startup", "what is an IPO", "startup IPO process"]
---
...
Not every company is IPO-ready. The general thresholds that investment banks and the SEC expect:

| Requirement | Typical Threshold |
|-------------|-------------------|
| Revenue (SaaS) | $100M+ ARR |
| Revenue growth | 30%+ YoY (at minimum) |
| Audited financials | 3 years required by SEC |
| Gross margin | >70% for software |
| Path to profitability | Clearly articulated |
| Process duration | 6–12 months minimum |

Beyond financials, companies need a "Big 4" audit firm, a board with independent directors, internal controls (SOX compliance), and general counsel experienced with SEC reporting.
...
6. **First trading day**: Shares open on the exchange; the opening price is set by market demand, often above the IPO price

## Traditional IPO vs. Alternatives

| Path | Description | Best For |
|------|-------------|----------|
| Traditional IPO | Underwritten offering; new shares issued; price set by banks | Companies seeking maximum capital raise |
| Direct Listing | No new shares; existing shareholders sell directly; price set by market | Companies that need liquidity but not new capital (Spotify, Coinbase, Slack) |
| SPAC Merger | Merge with a blank-check public company; faster but stigmatized post-2021 | Companies seeking faster certainty; less common in 2024 |

Direct listings have become a credible alternative for cash-rich, well-known companies. SPACs surged in 2020–21 and collapsed in credibility by 2022–23, with most SPAC-merged companies significantly underperforming.
...
## SaaS IPO Multiples: 2021 vs. 2023–24

The valuation environment for software IPOs changed dramatically between the 2021 peak and the 2023–24 reset:

| Year | Median SaaS IPO Multiple (EV/Forward Revenue) |
|------|-----------------------------------------------|
| 2021 | 25–40× |
| 2022 | 8–15× (rapidly compressing) |
| 2023–24 | 6–12× for quality companies |

Companies that IPO'd at peak 2021 multiples (like UiPath at 44× or HashiCorp at 30×) saw dramatic stock price declines as multiples normalized. The class of 2023–24 IPOs (Klaviyo, Rubrik, ServiceTitan) reflected a more disciplined market with higher profitability expectations.
