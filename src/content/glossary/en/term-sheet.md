---
title: "Term Sheet"
description: "A term sheet is a non-binding document outlining the key terms of a VC investment deal before formal legal agreements are drafted."
locale: "en"
...
| Clause Type | Examples | Binding? |
|-------------|----------|----------|
| Economic terms | Valuation, equity %, liquidation preference | Non-binding |
| Governance terms | Board composition, voting rights | Non-binding |
...
The term sheet will specify both the **pre-money valuation** (the company's value before the investment) and the **investment amount**, which together determine the post-money valuation and the investor's ownership stake.

**Example:** If a VC invests $2M at a $8M pre-money valuation, the post-money valuation is $10M, and the investor receives 20% of the company.
...
**Example:** A VC invests $5M with a 2x participating preference. In a $20M exit:
- VC receives $10M (2x preference)
- Remaining $10M is split pro-rata between VC and founders
...
The term sheet will define the composition of the board of directors. A typical early-stage arrangement for a Series A might be:
- 2 founder/management seats
- 1 investor seat
- 1 independent seat (mutually agreed upon)

Control of the board is as important as ownership percentage. A founder can own 40% of a company but lose operational control if the board votes against them.
...
Once you sign a term sheet with a no-shop clause, you are contractually prohibited from soliciting other investors for the specified exclusivity period. A 30-day window is reasonable. Push back on anything longer than 60 days, as it limits your negotiating leverage and leaves you exposed if the deal falls through.
...
- **Participating preferred with a high multiple** (2x or 3x): Dramatically reduces founder upside in smaller exits
- **Full ratchet anti-dilution**: Extremely punitive in a down round
- **Supermajority voting thresholds**: Can give a minority investor effective veto power
- **Drag-along rights without carve-outs**: Investors can force a sale you don't want
- **Aggressive no-shop periods** (90+ days): Removes your leverage if the deal slows down

Always have a startup-experienced attorney review any term sheet before you sign. The cost of good legal counsel is trivial compared to the long-term consequences of agreeing to unfavorable terms.
