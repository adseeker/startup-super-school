---
title: "Down Round"
description: "A down round occurs when a startup raises capital at a lower valuation than its previous round, triggering dilution and anti-dilution."
locale: "en"
...
relatedTerms: ["equity-dilution", "term-sheet", "series-a", "bridge-round"]
...
| Cause | Description |
|-------|-------------|
| Missed growth targets | The company grew slower than projected at the last raise |
| Market downturn | Public market multiples compressed, pulling private valuations down |
| Competitive pressure | A competitor gained market share, reducing the company's relative value |
| Previous overvaluation | The last round was priced too high relative to fundamentals |
| Cash emergency | The company needs capital urgently and cannot negotiate from strength |
| Sector rotation | Investor appetite for the company's sector has cooled |
...
| Anti-Dilution Type | Severity | Common in Market? |
|-------------------|----------|-------------------|
| Full ratchet | Extreme | Rare / red flag |
| Narrow-based weighted average | High | Uncommon |
| Broad-based weighted average | Moderate | Standard |
| None | None | Rare (founder-friendly) |
