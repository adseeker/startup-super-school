...
2. What is your value proposition for that customer?
3. Which channel will you use to reach them?
...
2. The outcome your customer achieves
3. Why you achieve it better than alternatives
...
1. **Price to match your sales motion.** A $200/month product cannot justify an enterprise sales cycle. A $50,000 annual contract cannot be self-serve.
2. **Package to surface value.** If your value driver is seats, price per seat. If it's usage, price on usage. Misaligned packaging creates churn.
3. **Start with fewer tiers.** Two tiers (core and growth) is almost always better than four at the early stage. Complexity slows decisions.

## Sequencing Your GTM: Do Not Do Everything at Once

The right GTM sequence for most early-stage startups:

1. **Weeks 1–4:** Lock your ICP and value proposition. Interview 10 target customers. Do not write a single email before this.
2. **Weeks 5–8:** Choose one channel. Run 50 experiments (outreach sequences, landing page variants, or content pieces). Measure conversion at each stage.
3. **Weeks 9–12:** Double down on what converted. Kill what didn't. Begin codifying repeatable sequences.
4. **Month 4+:** Add a second channel only once your primary channel is producing consistently.
