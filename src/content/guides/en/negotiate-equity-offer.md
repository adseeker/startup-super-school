---
title: "How to Negotiate an Equity Offer at a Startup"
description: "Understand every component of a startup equity offer — and learn exactly what to negotiate, what to ask, and how to evaluate your upside."
locale: "en"
category: "equity"
...
1. **What is the fully diluted share count?** You need this to convert your raw grant into a percentage.
2. **What was the most recent 409A valuation?** This tells you the current FMV and how the strike price compares.
3. **What was the valuation of your most recent funding round, and when did it close?** This gives you a sense of the current implied enterprise value.
4. **What is the liquidation preference structure?** Some investors have 1x or 2x participating preferred liquidation preferences that mean common stockholders (you) receive nothing until investors have been paid back. In a small acquisition, this can wipe out all employee option value.
5. **What is the current ARR or revenue run rate?** This gives you a signal on growth trajectory and how realistic the exit scenarios are.
6. **How many total shares are in the option pool, and what percentage of the fully diluted cap table does the pool represent?** This tells you how diluted the pool already is and how future hiring will affect your percentage.
