...
1. Restatement of their problem (proves you listened)
2. Your solution, scoped to their situation
3. The expected outcome (specific, measurable where possible)
4. Pricing with two options (full solution and a smaller entry point)
5. A clear call to action with a deadline
