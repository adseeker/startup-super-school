...
readingTime: 9
primaryKeyword: "startup data room"
...
steps:
  ...
  - name: "Compile the Legal folder"
    text: "Include incorporation documents, all equity financing agreements (SAFEs, convertible notes, stock purchase agreements), cap table in CSV or Carta export, option pool documentation, IP assignments from founders and employees, NDAs with key partners, and any material contracts. Flag any issues proactively."
  - name: "Build the Product and Customers section"
    text: "Include product roadmap, technical architecture overview (for tech-focused investors), key customer contracts or LOIs (redacted if necessary), customer reference list, case studies or testimonials, and churn analysis by cohort. This section proves that product and GTM are real, not just projected."
  - name: "Add Team documentation"
    text: "Include founder and key employee bios, an org chart, employment agreements for key personnel, and any consulting agreements with founders. Investors will verify LinkedIn profiles; ensure they match what's in the data room."
  - name: "Audit the data room before sharing"
...
faqs:
  ...
  - question: "What documents do investors most commonly request?"
    answer: "The most-requested documents in due diligence are: cap table (who owns what, fully diluted), 12–24 months of financial statements, customer contracts and churn data, incorporation documents and equity financing agreements, IP assignment agreements from all founders, and the financial model with assumptions. Missing or inconsistent versions of any of these documents cause delays."
  - question: "What are common data room red flags for investors?"
    answer: "Common issues that slow or kill deals: IP not properly assigned from founders to the company, cap table discrepancies between different documents, missing or incomplete equity agreements, founders on consulting agreements rather than employment agreements (raises questions about commitment and vesting), revenue numbers that don't reconcile across documents, and customer concentration (top 3 customers > 50% of revenue) without a clear diversification plan."
---
...
|----------|----------|------|
| **Docsend** | Seed to Series B, pitch decks + data room | $45–$150/month |
| **Google Drive** | Seed rounds, lightweight diligence | Free |
| **Notion** | Narrative-heavy company pages | Free–$20/month |
| **Dropbox Business** | File storage with some sharing controls | $15/month/user |
| **Intralinks / Datasite** | Late-stage, M&A, IPO | $500+/month |
