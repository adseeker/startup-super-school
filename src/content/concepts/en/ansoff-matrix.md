---
title: "Ansoff Matrix"
description: "The Ansoff Matrix is a strategic framework that maps four growth strategies based on whether you sell existing or new products to existing or new markets."
locale: "en"
category: "strategy"
tags: ["strategy", "growth", "market", "planning"]
difficulty: "beginner"
publishedDate: 2025-03-15
origin: "Igor Ansoff, 1957 - first published in the Harvard Business Review article 'Strategies for Diversification'"
primaryKeyword: "Ansoff matrix"
seoKeywords: ["Ansoff matrix", "Ansoff matrix startup", "four growth strategies Ansoff", "market penetration product development diversification", "Ansoff growth framework"]
relatedConcepts: ["blue-ocean-strategy", "porter-five-forces", "business-model-canvas", "value-proposition-canvas"]
faqs:
  - question: "What are the four strategies in the Ansoff Matrix?"
    answer: "The four strategies are: Market Penetration (existing product, existing market - grow your share), Product Development (new product, existing market - serve current customers better), Market Development (existing product, new market - reach new segments or geographies), and Diversification (new product, new market - the highest-risk quadrant)."
  - question: "Which Ansoff strategy is best for early-stage startups?"
    answer: "Market Penetration is almost always the right strategy for early-stage startups. Before expanding to new markets or building new products, you should dominate your initial beachhead market. Startups that diversify too early spread resources thin and rarely achieve the depth of product-market fit needed to win any single market."
  - question: "What is the riskiest quadrant in the Ansoff Matrix?"
    answer: "Diversification - entering a new market with a new product - carries the highest risk because you have no existing customer relationships or product experience to leverage. It is the strategy most likely to fail and is generally only viable for established companies with strong balance sheets, not resource-constrained startups."
  - question: "How does the Ansoff Matrix help with startup strategy?"
    answer: "The matrix forces a structured conversation about where growth will come from. It prevents the common startup mistake of pursuing growth in all directions simultaneously. By mapping your current position and considering the risk profile of each quadrant, you can make a deliberate, resource-appropriate decision about which growth lever to pull next."
---
...
**When to use it**: When you have [product-market fit](/glossary/product-market-fit) and your primary constraint is go-to-market reach, not product gaps or market size.
...
| Strategy | Risk Level | Capital Required | Time Horizon |
|----------|-----------|-----------------|--------------|
| Market Penetration | Low | Low | Short |
| Product Development | Medium | Medium | Medium |
