...
description: "The flywheel effect describes how consistent momentum across linked business activities creates compounding growth with no single breakthrough moment."
locale: "en"
category: "strategy"
...
seoKeywords: ["flywheel effect startup", "what is flywheel effect", "Amazon flywheel", "flywheel business model"]
---
...
| Concept | Scope | Time horizon | Who owns it |
|---------|-------|--------------|-------------|
| **Funnel** | Specific channel or conversion path | Short-term | Marketing |
| **Growth loop** | One user behavior mechanism | Medium-term | Growth / Product |
| **Flywheel** | Entire business model | Long-term | Leadership |
