...
|--|----------------------|----------------------|
| Target customer | Existing best customers | Non-consumers or low-end users |
| Value proposition | Better on existing metrics | Different metrics (cheaper, simpler) |
| Incumbent response | Natural and effective | Blind spot — rational to ignore |
| Typical example | iPhone 16 vs iPhone 15 | Early smartphones vs feature phones |
