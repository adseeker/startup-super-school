...
description: "The Lean Startup is a methodology for building products under extreme uncertainty, centered on validated learning and the Build-Measure-Learn feedback loop."
locale: "en"
...
|---------------|----------------------|
| Total sign-ups | Activation rate (% who complete key action) |
| Page views | Retention (% who return) |
