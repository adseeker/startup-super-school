---
title: "Kano Model"
description: "A framework for categorizing product features by how they affect customer satisfaction - from basic must-haves to unexpected delighters."
locale: "en"
category: "framework"
...
seoKeywords: ["Kano model startup", "what is Kano model", "Kano model product management", "Kano model feature prioritization"]
---
...
| Category | Present | Absent | Strategic Role |
|---|---|---|---|
| Must-Be | Neutral | Strong dissatisfaction | Table stakes |
| Performance | More = more satisfied | Less = more dissatisfied | Competitive differentiation |
| Attractive | Delight | No dissatisfaction | Emotional differentiation |
| Indifferent | No reaction | No reaction | Cut or deprioritize |
| Reverse | Dissatisfaction (for some) | Relief (for some) | Segment carefully |
