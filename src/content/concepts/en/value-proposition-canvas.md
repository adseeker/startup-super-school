...
seoKeywords: ["value proposition canvas startup", "what is value proposition canvas", "VPC framework startup", "value proposition canvas template"]
---

## Origins

The **Value Proposition Canvas (VPC)** was developed by Alexander Osterwalder and Yves Pigneur as a companion tool to the Business Model Canvas, which they introduced in *Business Model Generation* (2010). The VPC was first sketched in 2012 and fully formalized in *Value Proposition Design* (2014), co-authored with Alan Smith and Gregory Bernarda.

Where the Business Model Canvas maps an entire business model across nine blocks, the VPC zooms in on the two most critical blocks: the **Customer Segment** and the **Value Proposition**. The central insight of the tool is that most businesses fail not because of poor execution, but because they never achieve a genuine fit between what they offer and what a real customer actually needs.
...
The right side of the canvas describes your customer segment in three dimensions:
...
**Gains** are the outcomes and benefits customers desire. Some are required (they won't accept a solution without them), some are expected (standard for the category), some are desired (they'd love them but won't demand them), and some are unexpected (delighters they hadn't thought to want).
...
|---|---|---|
| Customer Jobs | Products & Services | Do your products help complete the job? |
| Pains | Pain Relievers | Do you address real, significant pains? |
| Gains | Gain Creators | Do you deliver outcomes customers actually want? |

## Achieving Fit

Fit is not achieved by filling in both sides of the canvas. It is achieved when the items you have listed on the left **directly and specifically address** the most important items on the right.
...
The VPC primarily targets the first stage, but it is most powerful when iterated through all three.

## How to Fill the Canvas Correctly

The single most common mistake when using the VPC is **filling in the Value Map first**. Teams describe their product, then construct a customer profile that matches it. This produces confirmation, not insight.
...
Those gaps are your product roadmap.

## Value Proposition Canvas vs. Jobs to Be Done
...
Using JTBD research to fill in the Customer Profile of the VPC is a particularly effective combination: JTBD interviews surface the jobs with depth and nuance; the VPC organizes them into a structured map that can be evaluated against a value proposition.
